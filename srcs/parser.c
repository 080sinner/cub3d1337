...
/*   Updated: 2022/04/27 20:36:35 by fbindere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	open_xpm_file(0, "textures/enemy0.xpm", cub->map.enemy, cub);
	open_xpm_file(1, "textures/enemy1.xpm", cub->map.enemy, cub);
	open_xpm_file(2, "textures/enemy2.xpm", cub->map.enemy, cub);
	open_xpm_file(3, "textures/enemy3.xpm", cub->map.enemy, cub);
	open_xpm_file(4, "textures/enemy4.xpm", cub->map.enemy, cub);
}
